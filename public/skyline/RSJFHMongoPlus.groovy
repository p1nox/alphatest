...
class RSJFHMongoPlus {
	...
	static void main(def args){			
		...
		COLLECTION_NAME.each{ col_name ->
			...
			def sortedCol = db[col_name].find().sort([ ((String) fname) : RULES_COL[col_name] ])			
		...
		println "TIME********************************************\nHours: "+CRONO.getHours()+"\nMinutes: "+CRONO.getMinutes()+"\nSeconds: "+CRONO.getSeconds()+"\nMiliseconds: "+CRONO.getMilliseconds()
	}
